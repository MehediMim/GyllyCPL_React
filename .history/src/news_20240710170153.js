...
const News = () => {
    ...
    return (
        <div className="bg-slate-200 pt-20 min-h-screen">
            ...
            <div className=" flex flex-wrap flex-col md:flex-row items-center justify-items-start bg-red-300 mx-20">
                {
                    ALLNews.map((news, index) => (
                        <div className="w-1/4 h-72 p-1 " onClick={() => expandNews(news)}>
                            <div className="bg-white">
                                ...
                                <div className="p-3 h-20  overflow-hidden text-2xl relative   text-slate-800 font-Titillium overflow-hidden">{news[1]}</div>
                            </div>
                        </div>
                    ))
                }
