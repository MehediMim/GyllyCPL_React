            ...
            <div className="flex bg-slate-900 p-3 z-50 fixed  w-full">
                 ...
                 <div className="w-2/3 text-white hidden mx-2 md:flex flex-row items-center " >
                    <div className="basis-1/5 font-Saira  text-sm md:text-xl group justify-center p-2 flex">
                        ...
                        <div className=" basis-1/5 absolute top-12 border-solid border-white  font-Saira text-sm md:text-xl z-10 group-hover:block hidden" onClick={handleShowall}>
                            <uL>
                                <li><div className="bg-slate-800 w-40 flex justify-center items-center p-2 block hover:text-amber-400"><Link to="/season4">Season 1</Link></div></li>
                                <li><div className="bg-slate-800 w-40 flex justify-center items-center p-2 block hover:text-amber-400"><Link to="/season4">Season 2</Link></div></li>
                                <li><div className="bg-slate-800 w-40 flex justify-center items-center p-2 block hover:text-amber-400"><Link to="/season4">Season 3</Link></div></li>
                                <li><div className="bg-slate-800 w-40 flex justify-center items-center p-2 block hover:text-amber-400"><Link to="/season4">Season 4</Link></div></li>
                            </uL>
                        </div>
                    </div>
                    ...
                    <div className=" basis-1/5 font-Saira text-sm hover:text-amber-400 md:text-xl justify-center p-2 flex" onClick={handleShowall}><Link to="/news">News</Link></div>
                </div>
                ...
                {Showall && <div className="w-2/3 text-white md:hidden mx-2 md:flex flex-row items-center " >
                    <div className="basis-1/5 font-Saira  text-sm md:text-xl group justify-center p-2 flex">
                        ...
                        <div className=" basis-1/5 absolute top-12 border-solid border-white  font-Saira text-sm md:text-xl z-10 group-hover:block hidden" onClick={handleShowall}>
                            <uL>
                                <li><div className="bg-slate-800 p-2 block hover:text-amber-400"><Link to="/season4">Season 1</Link></div></li>
                                <li><div className="bg-slate-800 p-2 block hover:text-amber-400"><Link to="/season4">Season 2</Link></div></li>
                                <li><div className="bg-slate-800 p-2 block hover:text-amber-400"><Link to="/season4">Season 3</Link></div></li>
                                <li><div className="bg-slate-800 p-2 block hover:text-amber-400"><Link to="/season4">Season 4</Link></div></li>
                            </uL>
                        </div>
                    </div>
                    <div className=" basis-1/5 font-Saira text-sm hover:text-amber-400 md:text-xl justify-center p-2 flex" onClick={handleShowall}><Link to="/team">Teams</Link></div>
