        ...
        <div className='' style={{ backgroundColor: props.team[3] }}>
            ...
            {variable &&
                <div className='relative  overflow-x-hidden'>
                    ...
                    <div className='pl-20  bg-red-300 w-2/3 j'>
                        <div className='flex bg-black justify-between w-2/3'>
                            <div className='font-Titillium text-white text-2xl'>CURRENT SQUAD</div>
                            <div className='font-Titillium text-white text-2xl'>CURRENT VALUE</div>
                        </div>
                        <div>
                            {
                                props.squad.map((player, key) => (
                                    <div>
                                        <div className=' relative  my-1'>
                                            <div className='flex bg-slate-400 w-2/3 justify-between items-center'>
