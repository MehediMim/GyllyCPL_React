            ...
            <div className="flex bg-slate-900 p-3 z-50 fixed  w-full">
                ...
                {/* LAPTOP */}
                 <div className="w-2/3 text-white hidden mx-2 md:flex flex-row items-center " >
                    ...
                    <div className=" basis-1/5 font-Saira text-sm hover:text-amber-400 md:text-xl justify-center p-2 flex" onClick={handleShowall}><Link to="/videos">Videos</Link></div>
                </div>
