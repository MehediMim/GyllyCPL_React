        ...
        <div className="pt-10 flex flex-wrap bg-slate-100 justify-evenly">
            {
                PlayerList.map((player, index) => (
                    <div className="w-3/4 md:w-1/5 xl:w-1/6 md:h-80 overflow-hidden justify-center flex flex-col items-center p-2 shadow-md m-2">
                        ...
                        <div className="relative w-full flex justify-center bottom-7 bg-gradient-to-t from-slate-900 text-white font-Saira text-3xl">{player[1]}</div>
