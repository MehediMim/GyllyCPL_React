                        ...
                        <div>
                            {
                                props.squad.map((player, key) => (
                                    <div>
                                        <div className=' relative bg-slate-300 my-1'>
                                            <div className='text-white absolute font-body text-5xl'>{player[0]}</div>
                                            <div className='text-white absolute font-Titillium text-2xl'>{player[1]}</div>
                                        </div>
                                    </div>
                                ))
                            }
