            ...
            <div className=" flex flex-wrap flex-col md:flex-row items-center justify-items-start bg-red-300 mx-20">
                {
                    ALLNews.map((news, index) => (
                        <div className="w-1/4 h-60 p-1 " onClick={() => expandNews(news)}>
                            <div className="bg-white">
                                <div className="h-36 overflow-hidden"><img src={news[0]} alt="news" className="w-80 h-48 object-cover"></img></div>
