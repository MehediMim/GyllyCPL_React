...
const ChngingRunDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:runDivs[varDiv][4]}}>
            ...
            <div className='absolute bottom-20 w-full flex justify-center font-Saira text-white text-5xl'>{runDivs[varDiv][0]}</div>
            <div className='absolute bottom-14 w-full flex justify-center font-body text-white text-3xl'>{divs[varDiv][1]}</div>
