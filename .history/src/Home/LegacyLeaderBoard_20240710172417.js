                ...
                <div className='flex flex-wrap justify-center'>
                {
                    teaminfo.map((team,key)=>(
                        <div className='m-2 w-60 h-72 '>
                            ...
                            <div>
                                <div className=' w-60 h-72 ring-1 ring-slate-700 rounded-md object-cover overflow-hidden relative bottom-24 z-0'>
                                    <img src={team.teamLogo} alt='hello' className='opacity-10 object-cover'></img>
                                </div>
                            </div>
                            <div className='flex justify-center '>
                                <div className='text-white relative bottom-64 flex justify-center items-center flex-col'>
                                    <div className='text-xl font-Titillium'>SEASONS</div>
                                    <div className='text-3xl font-Saira'>{team.seasonParticipated}</div>
                                </div>
                            </div>
                            <div className='flex justify-evenly '>
                                <div className='text-white relative bottom-64 flex justify-center items-center flex-col'>
                                    <div className='text-xl font-Titillium'>MATCHES</div>
                                    <div className='text-3xl font-Saira'>{team.matchPlay}</div>
                                </div>
                                <div className='text-white relative bottom-64 flex justify-center items-center flex-col'>
                                    <div className='text-xl font-Titillium'>WIN</div>
                                    <div className='text-3xl font-Saira'>{team.matchWin}</div>
                                </div>
                            </div>
                        </div>
                    ))
