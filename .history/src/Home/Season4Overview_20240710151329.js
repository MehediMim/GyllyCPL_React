...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full ' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='inherit bottom-20 flex justify-center font-Titillium text-white text-xl'>CAPTAIN</div>
            <div className='inherit bottom-20 flex justify-center font-Saira text-white text-3xl'>{divs[varDiv][0]}</div>
            <div className='inherit bottom-52 flex justify-center font-body text-white text-7xl'>{divs[varDiv][1]}</div>
            <div className='inherit  w-20   '><img src={divs[varDiv][2]} alt='LL'></img></div>
            <div className='inherit  w-80   right-36 opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
