...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full ' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute bottom-72 w-20   '><img src={divs[varDiv][2]} alt='LL'></img></div>
            <div className='relative  w-80  bottom-auto right-36 opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
