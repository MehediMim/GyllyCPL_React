    ...
    return (
        <div>
            <div className='relative'>
                ...
                <div className='flex justify-center w-full h-full bg-red-300  items-center text-white font-body text-6xl absolute bottom-10 '><div>PHOTOS</div></div>
            </div>
        </div>
    )
}
...
const Season4Overview = () => {
    return ( 
        <div className='px-20 my-20 bg-slate-900'>
            ...
            <div className='flex'>
                <div className='w-1/3 h-56 bg-white m-1 '><div className=' h-56 bg-orange-300  flex justify-center items-center'><ChngingImageDiv/></div></div>
