...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden relative' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute bottom-16 w-full flex justify-center left-5 md:left-0 font-Titillium text-white text-xl'>CAPTAIN</div>
            <div className='absolute bottom-10 w-full flex justify-center left-5 md:left-0 font-Saira text-white text-3xl'>{divs[varDiv][0]}</div>
            <div className='absolute bottom-20 w-full flex justify-center left-5 md:left-0 font-body text-white text-7xl'>{divs[varDiv][1]}</div>
