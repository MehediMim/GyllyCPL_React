                ...
                <div className='flex flex-wrap'>
                {
                    teaminfo.map((team,key)=>(
                        <div className='m-2 w-60 h-72 '>
                            <div className='z-30'>
                                <div className='m-3 text-white text-7xl font-Saira'>{key+1}</div>                                
                                <div className='m-3 text-white text-1xl font-Saira'>{team.teamName}</div>                                
                            </div>
                            <div>
                                <div className=' w-60 h-72 ring-1  object-cover overflow-hidden relative bottom-24 z-0'>
