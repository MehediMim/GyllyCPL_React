...
const divs=[
    ["Nakib Arman","NM69",NM69,"#5687A8"],
    ["SHAHRIAR KABIR","Gladiators",Gladiators,"#5687A8"],
    ["Zubaer Jahin","ShotGun",ShotGun,"#5687A8"],
...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden' style={{backgroundColor:divs[varDiv][3]}}>
