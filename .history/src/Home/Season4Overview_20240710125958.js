...
const Season4Overview = () => {
    return ( 
        <div className='px-20 py-20 my-20 bg-slate-900'>
            <div className='flex'>
                <div className='w-56 h-56 bg-orange-300 m-1 flex justify-center items-center'><div className='text-3xl font-body te text-white drop-shadow-md'>PHOTOS</div></div>
