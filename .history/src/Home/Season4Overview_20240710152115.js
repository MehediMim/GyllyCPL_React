...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full relative' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute flex justify-center items-center h-56  pl-10'><img src={divs[varDiv][2]} className='w-full ' alt='LL'></img></div>
            <div className='absolute -left-20 w-80   right-36 opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
