    ...
    return (<Fragment>
        <div className="bg-slate-200 pb-20">
            ...
            <div className='text-slate-900 pl-20 font-Saira text-4xl py-20'>
                ...
                <div className="mx-5 flex flex-col md:flex-row items-center md:items-stretch justify-evenly ">
                    {
                        trophys.map((trophy, key) => (
                            <div className="shadow-xl w-2/3 bg-black md:w-1/4  rounded-md flex flex-col items-center justify-center pt-5 my-5 md:my-0">
