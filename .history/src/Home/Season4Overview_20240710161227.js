...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden relative' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute flex justify-center items-center h-56 bg-black w-full  pl-10'><img src={divs[varDiv][2]} className='w-20 ' alt='LL'></img></div>
            <div className='absolute  w-80 bg-black   opacity-20'><img src={divs[varDiv][2]} alt='LL' ></img></div>
        </div>
    )
}
