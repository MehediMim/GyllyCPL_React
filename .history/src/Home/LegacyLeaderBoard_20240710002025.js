                ...
                <div className='flex flex-wrap justify-center'>
                {
                    teaminfo.map((team,key)=>(
                        <div className='m-2 w-60 h-72 '>
                            <div className='z-30 flex w-full bg-red-700 items-center justify-center'>
                                <div className='m-3 w-15 bg-slate-700 text-white text-7xl font-Saira'><div>{key+1}</div></div>                                
                                <div className='m-3 w-45 bg-slate-100 text-white text-2xl font-Saira'>{team.teamName}</div>                                
                            </div>
                            <div>
