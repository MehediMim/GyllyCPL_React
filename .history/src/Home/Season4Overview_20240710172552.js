    ...
    return (
        <div>
            <div className='relative'>
                <div className='bg-slate-900 relative'><img src={imageDiv[varDiv]} alt='LL' className='opacity-50 w-full'></img></div>
...
const ChngingRunDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:runDivs[varDiv][4]}}>
            ...
            <div className='absolute right-10 flex justify-center items-center h-56  pl-10'><div className='font-body text-white text-9xl z-10'>{runDivs[varDiv][2]}</div></div>
...
const ChngingWWicketDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:wicketDivs[varDiv][4]}}>
            ...
            <div className='absolute right-10 flex justify-center items-center h-56  pl-10'><div className='font-body text-white text-9xl z-10'>{wicketDivs[varDiv][2]}</div></div>
...
const Season4Overview = () => {
    return ( 
        <div className='px-1 md:px-20 my-20 bg-slate-900'>
            <div className='text-white font-Saira text-4xl py-20'>
            ...
            <div className='flex'>
                <div className='w-1/3 h-56 bg-white m-1'> <div className='bg-red-400 w-full text-white h-full flex justify-center font-body text-6xl items-center'><Link to="/news">NEWS</Link></div></div>
                <div className='w-1/3 h-56 bg-white m-1 '><div className=' h-56 bg-orange-300  flex justify-center items-center overflow-hidden'><ChngingImageDiv/></div></div>
                <div className='w-1/3 h-56 bg-white m-1'> <div className='bg-cyan-600 w-full text-white h-full flex justify-center font-body text-6xl items-center'><Link to="/season4">MATCH RESULTS</Link></div></div>
