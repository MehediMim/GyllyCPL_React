...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden relative' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute  w-80 bg-black flex justify-center items-center  opacity-20'><img src={divs[varDiv][2]} alt='LL' className='bg-white flex justify-center right-3'></img></div>
        </div>
    )
}
