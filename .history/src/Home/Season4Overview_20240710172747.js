    ...
    return ( 
        <div className='px-1 md:px-20 my-20 bg-slate-900'>
            ...
            <div className='flex'>
                ...
                <div className='w-1/3 hidden h-56 bg-white m-1'> <div className='bg-cyan-600 w-full text-white h-full flex justify-center font-body text-6xl items-center'><Link to="/season4">MATCH RESULTS</Link></div></div>
