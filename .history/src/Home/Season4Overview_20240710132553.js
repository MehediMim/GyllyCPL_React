...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden'>
            <div className='relative text-white opacity-15 w-full h-full ml-28 bg-white flex justify-center items-center'>
            ...
            <div className='relative  w-80  bottom-96 right-20 opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
