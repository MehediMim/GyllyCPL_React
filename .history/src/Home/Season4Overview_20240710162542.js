...
const ChngingImageDiv=()=>{
    ...
    return (
        <div>
            <div>
                <img src={imageDiv[varDiv]} alt='LL'></img>
            </div>
        </div>
    )
}
...
const Season4Overview = () => {
    return ( 
        <div className='px-20 my-20 bg-slate-900'>
            ...
            <div className='flex'>
                <div className='w-1/3 h-56 bg-white m-1'><div className='w-56 h-56 bg-orange-300 m-1 flex justify-center items-center'><div className='text-5xl font-body te text-white drop-shadow-md'><Link to="/photos">PHOTOS</Link></div></div></div>
