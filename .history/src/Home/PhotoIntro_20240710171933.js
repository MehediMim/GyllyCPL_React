    ...
    return (<Fragment>
        <div>
            ...
            <div className='mx-20 flex flex-wrap justify-between'>
                <div className='md:w-1/5 m-1'><img src={s1_1} alt='hello'></img></div>
                <div className='md:w-1/5 m-1'><img src={s1_3} alt='hello'></img></div>
                <div className='md:w-1/5 m-1'><img src={s1_4} alt='hello'></img></div>
                <div className='md:w-1/5 m-1'><img src={s1_5} alt='hello'></img></div>
            </div>
            <div className='mx-20 '>
