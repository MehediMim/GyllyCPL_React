...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full ' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='relative top-20 flex justify-center font-Titillium text-white text-xl'>CAPTAIN</div>
            ...
            <div className='relative  w-20   '><img src={divs[varDiv][2]} alt='LL'></img></div>
