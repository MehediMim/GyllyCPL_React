...
import _nuru from "../PlayerPngs/nuru.png";
...
const runDivs=[
    ["RIPON","SHOT GUN",61,NM69,"#C97925",1,_ripon],
    ["IMRAN","SYNDICATE",52,Syndicate,"#266B63",2,_imran],
    ["MISHU","SYNDICATE",50,Syndicate,"#266B63",3,_mishu],
    ["JN SAKIB","SHOTGUN",43,ShotGun,"#EFBF46",4,_jn],
    ["PARTHO","MACHINEGUN",42,MachineGun,"#5687A8",5,_partho],
    
];
const wicketDivs=[
    ["R REFAT","SYNDICATE",7,Syndicate,"#266B63",1,_refath],
    ["M RATUL","SYNDICATE",7,Syndicate,"#266B63",2,_ratul],
    ["WASIF","MACHINEGUN",6,MachineGun,"#5687A8",3,_wasif],
    ["MISHU","SYNDICATE",6,Syndicate,"#266B63",4,_mishu],
    ["RIPON","SHOTGUN",6,ShotGun,"#EFBF46",5,_ripon],
...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full overflow-hidden relative' style={{backgroundColor:divs[varDiv][3]}}>
            ...
            <div className='absolute z-10 bottom-16 w-full flex justify-center left-5 md:left-0 font-Titillium text-white text-xl'>CAPTAIN</div>
            <div className='absolute z-10 bottom-10 w-full flex justify-center left-5 md:left-0 font-Saira text-white text-3xl'>{divs[varDiv][0]}</div>
            <div className='absolute z-10 bottom-20 w-full flex justify-center left-5 md:left-0 font-body text-white text-7xl'>{divs[varDiv][1]}</div>
            <div className='absolute flex justify-center items-center h-56  w-1/3  pl-0 md:pl-10'><img src={divs[varDiv][2]} className='w-20 ' alt='LL'></img></div>
...
const ChngingRunDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:runDivs[varDiv][4]}}>
            ...
            <div className='absolute bottom-32 z-10 w-full flex justify-center right-5 md:right-0 font-Titillium text-white text-xl'>MOST RUNS</div>
            <div className='absolute bottom-20 z-10 w-full flex justify-center right-5 md:right-0 font-Saira text-white text-5xl'>{runDivs[varDiv][0]}</div>
            <div className='absolute bottom-14 z-10 w-full flex justify-center right-5 md:right-0 font-body text-slate-300 text-3xl'>{runDivs[varDiv][1]}</div>
            <div className='absolute flex justify-center items-center h-56  pl-10'><div className='font-body text-white text-7xl z-10 '>
                <div className='h-36 absolute bottom-0 left-0  bg-black'>
                    <div className='w-full h-full'><img src={runDivs[varDiv][6]}></img></div>
                </div>
                </div></div>
...
const ChngingWWicketDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:wicketDivs[varDiv][4]}}>
            ...
            <div className='absolute bottom-32 z-10 w-full flex justify-center right-5 md:right-0 font-Titillium text-white text-xl'>MOST WICKETS</div>
            <div className='absolute bottom-20 z-10 w-full flex justify-center right-5 md:right-0 font-Saira text-white text-5xl'>{wicketDivs[varDiv][0]}</div>
            <div className='absolute bottom-14 z-10 w-full flex justify-center right-5 md:right-0 font-body text-slate-300 text-3xl'>{wicketDivs[varDiv][1]}</div>
    ...
    return ( 
        <div className='px-1 md:px-20  my-20 bg-slate-900'>
            ...
            <div className='flex'>
                ...
                <div className='w-1/3 hidden md:block h-56 bg-white m-1'> <div className='bg-cyan-600 w-full text-white h-full flex justify-center font-body text-6xl items-center'><Link to="/season4">SCORESHEET</Link></div></div>
