                ...
                <div className="mx-5 flex flex-col flex-wrap md:flex-row items-center md:items-stretch justify-evenly ">
                    {
                        trophys.map((trophy, key) => (
                            <div className="ring-1 rounded-md p-1 ring-slate-400 w-44 h-80 md:w-44  flex flex-col items-center justify-center pt-5 my-5 md:my-5">
                                <div className="w-full h-60  overflow-hidden    flex justify-center items-center"><img src={trophy[0]} alt="syndicate" className="w-2/3"></img></div>
                                <div className=" w-2/3 h-24      font-Titillium text-3xl w-full flex-col items-center justify-center">
                                    <div className="w-full h-12  flex justify-center items-center">
                                        <div className="absolute text-5xl text-white font-body">CHAMPION</div>
                                        <ForPush j={trophy[1]} verdict={"c"} />
                                        </div>
                                    <div className="w-full h-12  flex justify-center items-center">
                                    <div className="absolute text-5xl text-white font-body">RUNNERUP</div>
                                        <ForPush j={trophy[2]} verdict={"r"} />
                                        </div>
                                </div>
                            </div>
                        ))
