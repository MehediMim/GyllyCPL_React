...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full relative' style={{backgroundColor:divs[varDiv][3]}}>
            <div className='absolute text-white opacity-15  h-full ml-44  flex justify-center items-center'>
                <div className='text-9xl font-body'>{divs[varDiv][1]}</div>
            </div>
            <div className='absolute bottom-16 w-1/2 bg-black flex justify-center font-Titillium text-white text-xl'>CAPTAIN</div>
            <div className='absolute bottom-20 flex justify-center font-Saira text-white text-3xl'>{divs[varDiv][0]}</div>
            <div className='absolute bottom-52 flex justify-center font-body text-white text-7xl'>{divs[varDiv][1]}</div>
            <div className='absolute  w-20   '><img src={divs[varDiv][2]} alt='LL'></img></div>
            <div className='absolute  w-80   right-36 opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
