...
const ChngingRunDiv=()=>{
    ...
    return (
        <div className=' w-full h-full  overflow-hidden relative' style={{backgroundColor:runDivs[varDiv][4]}}>
            ...
            <div className='absolute bottom-32 w-full flex justify-center font-Titillium text-white text-xl'>MOST RUNS</div>
            <div className='absolute bottom-24 w-full flex justify-center font-Saira text-white text-4xl'>{runDivs[varDiv][0]}</div>
            <div className='absolute bottom-16 w-full flex justify-center font-body text-white text-3xl'>{divs[varDiv][1]}</div>
            <div className='absolute flex justify-center items-center h-56  pl-10'><div className='font-body text-white text-9xl z-50'>{runDivs[varDiv][5]}</div></div>
            <div className='absolute flex justify-center items-center h-56  pl-10'><div className='font-body text-white text-9xl z-50'>{runDivs[varDiv][2]}</div></div>
            <div className='absolute  w-80  opacity-20'><img src={divs[varDiv][2]} alt='LL'></img></div>
        </div>
    )
}
