...
const ChngingImageDiv=()=>{
    ...
    return (
        <div>
            <div>
                <div className='bg-slate-900'><img src={imageDiv[varDiv]} alt='LL' className='opacity-50'></img></div>
                <div className='text-white relative bottom-10'>PHOTOS</div>
            </div>
        </div>
    )
}
...
const Season4Overview = () => {
    return ( 
        <div className='px-20 my-20 bg-slate-900'>
            ...
            <div className='flex'>
                <div className='w-1/3 h-56 bg-white m-1 overflow-hidden'><div className=' h-56 bg-orange-300  flex justify-center items-center'><ChngingImageDiv/></div></div>
