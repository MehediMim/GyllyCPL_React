...
const Season4Overview = () => {
    return ( 
        <div className='px-20 my-20 bg-slate-900'>
            ...
            <div className='flex'>
                <div className='w-1/3 h-56 bg-white m-1'> <div className='bg-red-400 w-full text-white h-full flex justify-center font-body text-6xl items-center'>NEWS</div></div>
