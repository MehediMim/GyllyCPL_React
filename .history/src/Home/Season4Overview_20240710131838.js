...
const ChngingDiv=()=>{
    ...
    return (
        <div className=' w-full h-full'>
            <div className='relative text-white opacity-15 w-full h-full flex justify-center items-center'>
                <div className='text-9xl font-body'>{divs[varDiv][1]}</div>
            </div>
            <div className='relative bottom-24 flex justify-center font-Titillium text-white text-xl'>CAPTAIN</div>
            <div className='relative bottom-24 flex justify-center font-Titillium text-white text-4xl'>{divs[varDiv][0]}</div>
        </div>
    )
}
