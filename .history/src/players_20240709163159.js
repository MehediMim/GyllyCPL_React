...
const PlayerList = [
    ...
    [_JHJim  ,"JHJim  ","BATSMAN"],
    [_Jubayer,"Jubayer","BATSMAN"],
    [_Rickto ,"Rickto ","BATSMAN"],
    [_Ridwan ,"Ridwan ","BATSMAN"],
    [_Sabbir ,"Sabbir ","BATSMAN"],
    [_Sajir  ,"Sajir  ","BATSMAN"],
    [_NakibArzon, "Nakib Arzon", "BATSMAN"]];
const Players = () => {

    return (
        <Fragment>
            <div className="pt-32 bg-slate-100  text-slate-900 flex justify-center font-body text-5xl">PLAYERS</div>
