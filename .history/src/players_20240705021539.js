        ...
        <div className="pt-10 flex flex-wrap bg-slate-100">
            {
                PlayerList.map((player, index) => (
                    <div className="w-full md:w-1/5 h-auto overflow-hidden justify-center md:flex flex-col items-center p-2 shadow-md m-2">
                        <div className="w-full h-3/4 object-cover flex justify-center"><img src={player[0]} alt="Player" className="w-full object-cover "></img></div>
