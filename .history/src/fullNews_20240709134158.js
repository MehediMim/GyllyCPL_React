    ...
    return ( <Fragment>
        <div className=" bg-white relative w-screen px-20 top-20 left-1/2 transform -translate-x-1/2  z-30">
            <div className="flex items-center">
                ...
                <div className=" relative -left-10 z-30  h-72 object-cover "><img src={props.news[0]} alt=""></img></div>
            </div>
            <div className="font-Titillium bg-white z-50 w-1/2">{props.news[2]}</div>
        </div>
