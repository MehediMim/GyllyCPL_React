        ...
        <Fragment>
            <div className="relative top-16 md:top-10 z-2 bg-slate-900">
                ...
                <div className="absolute w-full top-10  md:top-36  text-white flex flex-col place-items-center justify-center">
                    ...
                    <div className="text-2xl md:text-xl text-sm font-Titillium"><h1 className="bg-whitewhite md:text-white">CHAMPIONS OF GULLY CRICKET PREMIER LEAGUE SEASON 4</h1></div>
                </div>
                <News/>
                <TrophyCabinet/>
