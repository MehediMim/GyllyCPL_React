...
const FullNews = (props) => {
    return ( <Fragment>
        <div className=" bg-white absolute w-screen px-20 top-20 left-1/2 transform -translate-x-1/2  z-30 relative">
            ...
            <div className="font-Titillium bg-white z-50 w-1/2 text-xl mb-10">{props.news[2]}</div>
        </div>
