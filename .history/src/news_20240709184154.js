...
const News=()=>{
    ...
    return (
        <div className="bg-slate-200 pt-20">
            <div className="font-body text-4xl flex justify-center mt-10 mb-20 bg-slate-300">NEWS</div>
            <div className=" flex flex-col md:flex-row items-center justify-center">
                {
                    ALLNews.map((news,index)=>(
                        <div className="w-80 m-1 " onClick={()=>expandNews(news)}>
                            ...
                            <div className="p-3 bg-gradient-to-t from-black font-body text-2xl relative bottom-2 text-white overflow-hidden">{news[1]}</div>
                        </div>
                    ))
                }
            </div>
