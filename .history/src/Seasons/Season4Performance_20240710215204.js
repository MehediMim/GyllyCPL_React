                    ...
                    <div className='h-20 md:h-32 flex m-1 md:mx-44 relative' style={{ backgroundColor: player[4] }}>
                        ...
                        <div className='flex-grow flex md:pl-16  justify-start items-center h-full'>
                            ...
                            <div className='relative w-full'>
                                <div className='font-Saira absolute -bottom-2 text-white md:text-5xl text-3xl'>{player[0]}</div>
                                <div className='font-body absolute -bottom-8 text-white md:text-3xl text-xl'>{player[1]}</div>
                            </div>
                        </div>
