        ...
        <div className='bg-slate-200'>
            ...
            <div className='flex flex-wrap justify-center'>
            {
                groupMatchInfo.map((match,key)=>(
                    <div className='bg-slate-300 w-2/5 m-3'>
                        ...
                        <div className='flex bg-white justify-center'> 
                            ...
                            <div className='flex w-1/3 items-center bg-slate-600 justify-end pr-4 font-body text-2xl'>
                        ...
                        <div className='flex bg-white justify-center'> 
                            ...
                            <div className='flex items-center w-1/3 bg-slate-600 justify-end pr-4 font-body text-2xl'>
