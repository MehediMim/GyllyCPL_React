...
const Season4Matches = () => {
    return (<div className='pt-32 bg-slate-200'>
        
        <div className='text-slate-900  font-Saira px-6 md:px-20 text-4xl py-20'>
          <div>MATCH RESULTS</div>
        </div><div>
            <div className='bg-slate-200 font-Saira pt-10'><div className='md:ml-28 px-3 text-xl bg-slate-900 md:w-60 w-20 text-white'>GROUP STAGE</div></div>
            <MatchExplre groupMatchInfo={groupMatchInfo} />
        </div>
        <div>
            <div className='bg-slate-200 font-Saira pt-10'><div className='md:ml-28 px-3 text-xl bg-slate-900 md:w-60 w-32 text-white'>SEMI FINAL</div></div>
            <MatchExplre groupMatchInfo={koMatchInfo} />
        </div>
        <div>
            <div className='bg-slate-200 font-Saira pt-10'><div className='md:ml-28 px-3 text-xl bg-slate-900 md:w-60 w-32 text-white'>FINAL</div></div>
