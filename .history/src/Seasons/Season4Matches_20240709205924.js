...
<div className='bg-slate-200'>
            ...
            <div className='md:flex flex-wrap justify-center pt-10'>
            {
                prop.groupMatchInfo.map((match,key)=>(
                    <div className='bg-slate-200 drop-shadow-md md:w-2/5 md:m-3 mt-10 mx-1'>
...
<div className='text-slate-950 text-5xl font-body flex justify-center bg-slate-300 '>MATCH RESULT</div>
        <div>
            <div className='bg-slate-200 font-Saira pt-10'><div className='ml-28 px-3 text-xl bg-slate-900 w-60 text-white'>GROUP STAGE</div></div>
            <MatchExplre groupMatchInfo={groupMatchInfo}/>
        </div>
        <div>
            <div className='bg-slate-200 font-Saira pt-10'><div className='ml-28 px-3 text-xl bg-slate-900 w-60 text-white'>SEMI FINAL</div></div>
