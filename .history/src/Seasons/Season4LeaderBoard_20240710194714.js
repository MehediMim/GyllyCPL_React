  ...
  return (<Fragment>
    <div className="bg-slate-900 ">
      <div className="font-body text-black text-5xl w-full ">
        ...
        <div >
          {
            variable && <div className="flex flex-col md:flex-row items-center md:items-stretch justify-evenly pt-10">
            <div className="shadow-xl md:w-1/2 md:ml-24 md:mr-5  rounded-md flex flex-col items-center justify-start pt-5 mb-5 my-5 md:my-0">
