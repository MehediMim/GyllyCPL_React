...
const wicketDivs=[
    ["R REFAT","SYNDICATE",7,_refath,"#266B63",1],
    ["M RATUL","SYNDICATE",7,_ratul,"#266B63",2],
        ...
        <div>
            {
                props.runDivs.map((player, key) => (
                    <div className='h-32 flex m-1 mx-44 relative' style={{ backgroundColor: player[4] }}>
                                <div className='font-body absolute flex  justify-center  opacity-10 w-full text-white text-9xl'>{player[1]}</div>
                        ...
                        <div className='flex-grow flex pl-16 justify-start items-center h-full'>

                            <div className='relative w-full'>
                                <div className='font-Saira absolute -bottom-2 text-white text-5xl'>{player[0]}</div>
                                <div className='font-body absolute -bottom-8 text-white text-3xl'>{player[1]}</div>
                            </div>
                        </div>
            ...
            </div>
            {
                variable && <div>
                    <div className='batting my-20'>
                        <div className='flex h-10 bg-white mx-44 font-Saira text-xl text-slate-900'>
                    ...
                    <div className='batting my-20'>
                        <div className='flex h-10 bg-white mx-44 font-Saira text-3xl text-slate-900'>
                            <div className='flex-grow flex justify-center items-center'>PLAYER</div>
