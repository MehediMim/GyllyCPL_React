...
const Season4Intro = () => {
  return (
    <Fragment>
      ...
      <div className=" md:h-4/5 absolute  z-30  md:mt-20 top-16">
        <div className="  md:justify-between md:ml-10 flex flex-col justify-center md:justify-normal md:items-baseline items-center  md:pl-10 pt-10  md:pl-10 ">
          <div>
        ...
        <div className=' bg-black flex flex-col md:flex-row mx-20 mt-10 xl:mt-16 justify-between'>
          <div className='bg-slate-500 md:w-1/2 flex flex-col items-center'>
          ...
          <div className=' flex flex-col md:w-1/2 items-center'>
            <div className='text-xl text-white'>RUNNERS UP</div>
            <div className='text-5xl text-white'>SHOT GUN</div>
            <div className='w-1/4'><img src={ShotGun}></img></div>
          </div>
        </div>
