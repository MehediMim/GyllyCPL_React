            ...
            >
                <div className="bg-gradient-to-r from-black h-72 md:h-4/5 ">
                    <div className="  md:justify-between  pl-10 pt-10  md:pl-10 ">
                        <div>
                            <div className="text-white text-6xl md:text-8xl font-Saira">{props.season}</div>
                            <div className="text-white text-2xl md:text-4xl font-Titillium">{props.seasonDate}</div>
                        </div>
                        <div className="w-1/2 md:w-1/5 pt-7"> <img src={props.seasonLogo} alt="season4Logo" className="w-1/2"></img></div>
