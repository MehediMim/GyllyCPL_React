...
const runDivs = [
    ["RIPON", "SHOTGUN", 61, _ripon, "#EFBF46", 1],
    ...
    ["REFATH", "SYNDICATE", 41, _refath, "#266B63", 6],
    ["ROUDRO", "NM69", 40, _roudro, "#C97925", 7],
    ["SAKIB", "SHOTGUN", 39, _sakib, "#EFBF46", 8],
    ["RIDWAN", "NM69", 34, _ridwan, "#C97925", 9],
    ["REASON", "GLADIATORS", 32, _reason, "#3C3C3B", 10],
...
const wicketDivs=[
    ...
    ["PARTHO","MACHINEGUN",5,_partho,"#5687A8",6],
    ["ROUDRO","NM69",5,_roudro,"#C97925",7],
    ["KABBO","MAVERICKS",4,_kabbo,"#6A0000",8],
    ["KABIR","GLADIATORS",4,_kabir,"#3C3C3B",9],
    ["NURU","MAVERICKS",4,_nuru,"#6A0000",10],
];
