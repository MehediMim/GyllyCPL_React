...
const runDivs = [
    ...
    ["REFAT", "SHOT GUN", 41, _refat, "#5687A8", 6],
    ["ROUDRO", "NOOBMASTERS", 40, _roudro, "#5687A8", 7],
    ["SAKIB", "SHOT GUN", 39, _sakib, "#5687A8", 8],
    ["RIDWAN", "NOOBMASTERS", 34, _ridwan, "#5687A8", 9],
...
const wicketDivs=[
    ...
    ["ROUDRO","NOOBMASTERS",5,_roudro,"#EFBF46",7],
