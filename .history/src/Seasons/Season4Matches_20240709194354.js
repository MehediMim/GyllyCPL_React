                    ...
                    <div className='bg-slate-300 w-1/2 '>
                        <div className='flex bg-white justify-center'> 
                            <div className='w-2/3 flex bg-slate-300'>
                                <div className='w-1/4 bg-slate-700 flex justify-center'><img src={teamInfo[match.team1][2]} className='h-10'></img></div>
                                <div className='flex items-center'>{teamInfo[match.team1][1]}</div>
                            </div>
                            <div className='flex w-1/3 bg-slate-600 justify-end'>
