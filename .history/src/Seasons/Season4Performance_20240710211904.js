                    ...
                    <div className='h-32 flex m-1 mx-44 ' style={{ backgroundColor: player[4] }}>
                        ...
                        <div className='flex-grow flex pl-16 justify-start items-center h-full'>
                            ...
                            <div className='relative'>
                                <div className='font-Saira absolute -bottom-03 text-white text-5xl'>{player[0]}</div>
                                <div className='font-body absolute -bottom-6 text-white text-3xl'>{player[0]}</div>
                            </div>
                        </div>
