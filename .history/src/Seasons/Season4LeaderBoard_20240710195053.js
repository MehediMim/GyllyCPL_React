  ...
  return (<Fragment>
    <div className="bg-slate-900 ">
      <div className="font-body text-black text-5xl w-full ">
        <div className='text-white flex items-center font-Saira px-6 md:px-20 text-4xl py-20'>
          <div>POINT TABLE</div>
          <div><button onClick={funct}><FontAwesomeIcon icon={faAnglesDown} size="xl" style={{color: "#ffffff",}} /></button></div>
        </div>
        <div >
          {
            variable && <div className="flex flex-col md:flex-row items-center md:items-stretch justify-evenly  pb-20">
