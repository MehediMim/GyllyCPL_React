  ...
  return (
    <Fragment>
      <div className="bg-slate-900">
          ...
          <Season4TeamList/> 
          <Season4LeaderBoard/>
          <div className="bg-slate-200 font-Titillium flex justify-center"><div className="bg-slate-900 flex justify-center text-white w-1/4 pl-5">ALL MATCH STAT</div></div>
      </div>
    </Fragment>
  );
};
