        ...
        <div>
            {
                props.runDivs.map((player, key) => (
                    <div className='h-20 md:h-32 flex m-1 md:mx-44 relative' style={{ backgroundColor: player[4] }}>
                        ...
                        <div className='w-16 md:w-32 h-full  flex justify-center items-center'><div className='text-5xl font-Saira text-white'>{key + 1}</div></div>
                        <div className='md:w-52 w-32 bg-black h-full relative left-20 bottom-'>
