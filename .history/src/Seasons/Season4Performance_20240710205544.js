        ...
        <div>
            {
                props.runDivs.map((player, key) => (
                    <div className='h-32 flex m-1 mx-44' style={{backgroundColor:player[4]}}>
                        <div className='w-32 h-full bg-slate-100 flex justify-center items-center'><div className='text-5xl font-Saira text-white'>{key+1}</div></div>
                        <div className='w-52 h-full bg-slate-900'></div>
