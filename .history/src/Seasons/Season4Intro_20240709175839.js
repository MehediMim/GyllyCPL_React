  ...
  return (
    <Fragment>
      ...
      <div className=" md:h-4/5 absolute z-30 md:ml-10 md:mt-20 top-16">
        <div className="  md:justify-between flex flex-col justify-center md:justify-normal md:items-baseline items-center  pl-10 pt-10  md:pl-10 ">
          <div>
          ...
          <div className="w-1/2 md:w-1/5 pt-7 mb-5"> <img src={Season4Logo} alt="season4Logo" className="w-1/2"></img></div>
          <div className="text-slate-900 bg-white w-96 justify-center flex items-center text-xl md:text-xl font-Titillium ">
