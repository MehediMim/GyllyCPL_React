...
const Players = () => {
    ...
    return (
        ...
        <div className="pt-10 flex flex-wrap bg-slate-100 justify-center">
            {
                PlayerList.map((player, index) => (
                    <div className="w-full md:w-1/6 h-auto overflow-hidden justify-center md:flex flex-col items-center p-2 shadow-md m-2">
